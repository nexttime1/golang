...
var file_video_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x32, 0x38, 0x0a, 0x0c, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69,
...
var file_video_proto_depIdxs = []int32{
	0, // 0: proto.VideoService.Buy:input_type -> proto.Request
	1, // 1: proto.VideoService.Buy:output_type -> proto.Response
...
func (c *videoServiceClient) Buy(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.VideoService/Buy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedVideoServiceServer) Buy(context.Context, *Request) (*Response, error) {
...
func _VideoService_Buy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VideoServiceServer).Buy(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VideoService/Buy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VideoServiceServer).Buy(ctx, req.(*Request))
	}
...
var _VideoService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Buy",
			Handler:    _VideoService_Buy_Handler,
		},
	},
